...
abstract class _IapStore with Store {
  ...
  buy(String productSku) async {
       ...
       */
        ...
        appStore.openAlert("Your purchase was successful but we need some more time to validate it, should arrive soon! Otherwise contact the support (support@myapp.com)");
			}
